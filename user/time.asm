...
main(int argc, char ** argv) 
{
  ...
  36:	82e50513          	addi	a0,a0,-2002 # 860 <malloc+0xf6>
  ...
  50:	80450513          	addi	a0,a0,-2044 # 850 <malloc+0xe6>
  ...
  98:	7dc50513          	addi	a0,a0,2012 # 870 <malloc+0x106>
...
free(void *ap)
{
 ...
 6f0:	1bc7b783          	ld	a5,444(a5) # 8a8 <freep>
...
malloc(uint nbytes)
{
 ...
 792:	11a53503          	ld	a0,282(a0) # 8a8 <freep>
 ...
 7ba:	0f290913          	addi	s2,s2,242 # 8a8 <freep>
  if(p == (char*)-1)
 7be:	5afd                	li	s5,-1
 7c0:	a88d                	j	832 <malloc+0xc8>
    base.s.ptr = freep = prevp = &base;
 7c2:	00000797          	auipc	a5,0x0
 7c6:	0ee78793          	addi	a5,a5,238 # 8b0 <base>
 7ca:	00000717          	auipc	a4,0x0
 7ce:	0cf73f23          	sd	a5,222(a4) # 8a8 <freep>
 7d2:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7f4:	0aa73c23          	sd	a0,184(a4) # 8a8 <freep>
      return (void*)(p + 1);
 ...
 842:	b6e080e7          	jalr	-1170(ra) # 3ac <sbrk>
  if(p == (char*)-1)
